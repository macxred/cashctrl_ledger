...
ACCOUNTS = """
    ...
    2000,CHF,<values><en>Accounts payable</en><de>Kreditoren</de><fr>Créanciers</fr><it>Creditori</it></values>,,/Liabilities & Equity/Langfristiges Fremdkapital/Verzinsliche Verbindlichkeiten
    2030,CHF,<values><en>Advances received</en><de>Erhaltene Anzahlungen</de><fr>Acomptes reçus de tiers</fr><it>Anticipi ricevuti da terzi</it></values>,,/Liabilities & Equity/Langfristiges Fremdkapital
    2100,CHF,<values><en>Short-term bank liabilities</en><de>Bankverbindlichkeiten kurzfristig</de><fr>Dettes bancaires à court terme</fr><it>Debiti verso banche a breve termine</it></values>,,/Liabilities & Equity/Langfristiges Fremdkapital
    2120,CHF,<values><en>Short-term financial leasing</en><de>Finanzierungsleasing kurzfristig</de><fr>Engagements de financement par leasing à court terme</fr><it>Impegni da leasing finanziari a breve termine</it></values>,,/Liabilities & Equity/Langfristiges Fremdkapital
    2140,CHF,<values><en>Other interest-bearing liabilities</en><de>Übrige verzinsliche Verbindlichkeiten</de><fr>Autres dettes portant intérêt envers des tiers</fr><it>Altri debiti onerosi verso terzi</it></values>,,/Liabilities & Equity/Langfristiges Fremdkapital
    2200,CHF,<values><en>Sales tax payable</en><de>Umsatzsteuer</de><fr>TVA due</fr><it>IVA dovuta</it></values>,,/Liabilities & Equity/Langfristiges Fremdkapital/Übrige Verbindlichkeiten
    2202,CHF,<values><en>Tax compensation settlement method</en><de>Umsatzsteuerausgleich Abrechnungsmethode</de><fr>Réconciliation du chiffre d'affaires suite à un changement de methode</fr><it>Compensazione IVA dovuta in base al metodo di rendiconto</it></values>,,/Liabilities & Equity/Langfristiges Fremdkapital/Übrige Verbindlichkeiten
    2206,CHF,<values><en>Withholding tax payable</en><de>Verrechnungssteuer</de><fr>Impôt anticipé à payer</fr><it>Imposta preventiva</it></values>,,/Liabilities & Equity/Langfristiges Fremdkapital/Übrige Verbindlichkeiten
    2208,CHF,<values><en>Direct taxes</en><de>Direkte Steuern</de><fr>Impôts directs</fr><it>Imposte dirette</it></values>,,/Liabilities & Equity/Langfristiges Fremdkapital/Übrige Verbindlichkeiten
    2210,CHF,<values><en>Other short-term liabilities</en><de>Sonstige kurzfristige Verbindlichkeiten</de><fr>Autres dettes à court terme envers des tiers</fr><it>Altri debiti a breve termine verso terzi</it></values>,,/Liabilities & Equity/Langfristiges Fremdkapital/Übrige Verbindlichkeiten
    2261,CHF,<values><en>Profit distribution</en><de>Beschlossene Ausschüttungen</de><fr>Dividendes</fr><it>Dividendi</it></values>,,/Liabilities & Equity/Langfristiges Fremdkapital/Übrige Verbindlichkeiten
    2270,CHF,<values><en>Social security payable</en><de>Sozialversicherungen</de><fr>Assurances sociales</fr><it>Sicurezza sociale</it></values>,,/Liabilities & Equity/Langfristiges Fremdkapital/Übrige Verbindlichkeiten
    2279,CHF,<values><en>Withholding tax</en><de>Quellensteuer</de><fr>Compte courant Impôt à la source</fr><it>Conto corrente imposta alla fonte</it></values>,,/Liabilities & Equity/Langfristiges Fremdkapital/Verzinsliche Verbindlichkeiten
    2300,CHF,<values><en>Expenses not yet paid</en><de>Noch nicht bezahlter Aufwand</de><fr>Charges à payer</fr><it>Costi da pagare</it></values>,,/Liabilities & Equity/Langfristiges Fremdkapital
    2301,CHF,<values><en>Unearned revenue</en><de>Erhaltener Ertrag des Folgejahres</de><fr>Produits encaissés d'avance</fr><it>Ricavi ricevuti dell'anno successivo</it></values>,,/Liabilities & Equity/Langfristiges Fremdkapital
    2330,CHF,<values><en>Short-term provisions</en><de>Kurzfristige Rückstellungen</de><fr>Provisions à court terme</fr><it>Accantonamenti a breve termine</it></values>,,/Liabilities & Equity/Langfristiges Fremdkapital
    2400,CHF,<values><de>Bankverbindlichkeiten langfristig</de><en>Long-term bank liabilities</en><fr>Dettes bancaires à long terme</fr><it>Debiti verso banche a lungo termine</it></values>,,/Liabilities & Equity/Langfristiges Fremdkapital/Verzinsliche Verbindlichkeiten
    2420,CHF,<values><de>Finanzierungsleasing langfristig</de><en>Long-term financial leasing</en><fr>Engagement de financement par leasing à long terme</fr><it>Impegni da leasing finanziari a lungo termine</it></values>,,/Liabilities & Equity/Langfristiges Fremdkapital/Verzinsliche Verbindlichkeiten
    2430,CHF,<values><de>Obligationenanleihen</de><en>Bonds payable</en><fr>Emprunts obligatoires</fr><it>Prestiti obbligazionari</it></values>,,/Liabilities & Equity/Langfristiges Fremdkapital/Verzinsliche Verbindlichkeiten
    2450,CHF,<values><de>Darlehen</de><en>Loans</en><fr>Emprunts</fr><it>Prestiti</it></values>,,/Liabilities & Equity/Langfristiges Fremdkapital/Verzinsliche Verbindlichkeiten
    2451,CHF,<values><de>Hypotheken</de><en>Mortgages</en><fr>Hypothèques</fr><it>Mutui ipotecari</it></values>,,/Liabilities & Equity/Langfristiges Fremdkapital/Verzinsliche Verbindlichkeiten
    2500,CHF,<values><de>Unverzinsliche langfristige Verbindlichkeiten</de><en>Non-interest-bearing long-term liabilities</en><fr>Autres dettes à long terme á l'égard de tiers sans intérêts</fr><it>Altri debiti a lungo termine verso terzi non onerosi</it></values>,,/Liabilities & Equity/Langfristiges Fremdkapital/Übrige Verbindlichkeiten
    2600,CHF,<values><de>Langfristige Rückstellungen</de><en>Long-term provisions</en><fr>Provisions à long terme</fr><it>Accantonamenti a lungo termine</it></values>,,/Liabilities & Equity/Langfristiges Fremdkapital/Rückstellungen
    2800,CHF,"<values><en>Nominal capital, Share capital</en><de>Stammkapital, Aktienkapital</de><fr>Capital social, Capital-actions</fr><it>Capitale sociale, Capitale azionario</it></values>",,/Liabilities & Equity/Langfristiges Fremdkapital
    2820,CHF,<values><en>Private equity (partner)</en><de>Privat Gesellschafter</de><fr>Capital propre associé</fr><it>Capitale proprio socio</it></values>,,/Liabilities & Equity/Langfristiges Fremdkapital
    2850,CHF,<values><en>Private equity (sole entrepreneur)</en><de>Privat Einzelunternehmer</de><fr>Capital propre (raison individuelle)</fr><it>Capitale proprio (ditte individuali)</it></values>,,/Liabilities & Equity/Langfristiges Fremdkapital
    2900,CHF,<values><en>Statutory capital reserves</en><de>Gesetzliche Kapitalreserve</de><fr>Réserve légale issue du capital</fr><it>Riserva legale da capitale</it></values>,,/Liabilities & Equity/Langfristiges Fremdkapital
    2930,CHF,"<values><en>Reserve for own shares</en><de>Reserve für eigene Kapitalanteile</de><fr>Réserve propres actions, parts sociales</fr><it>Riserva proprie quote di capitale</it></values>",,/Liabilities & Equity/Langfristiges Fremdkapital
    2940,CHF,<values><en>Revaluation reserve</en><de>Aufwertungsreserve</de><fr>Réserve d'évaluation</fr><it>Riserva da rivalutazioni</it></values>,,/Liabilities & Equity/Langfristiges Fremdkapital
    2950,CHF,<values><en>Statutory retained earnings</en><de>Gesetzliche Gewinnreserve</de><fr>Réserve légale issue du bénéfice</fr><it>Risserva legale da utili</it></values>,,/Liabilities & Equity/Langfristiges Fremdkapital
    2960,CHF,<values><en>Voluntary retained earnings</en><de>Freiwillige Gewinnreserven</de><fr>Réserves facultative</fr><it>Riserva facultative</it></values>,,/Liabilities & Equity/Langfristiges Fremdkapital
    2979,CHF,<values><en>Annual profit or loss</en><de>Jahresgewinn oder -verlust</de><fr>Bénéfice ou perte de l'exercice</fr><it>Utile annuo o perdita annua</it></values>,,/Liabilities & Equity/Langfristiges Fremdkapital
